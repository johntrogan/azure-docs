...
|[Private endpoints (inbound)](../articles/azure-functions/functions-networking-options.md#private-endpoints-inbound)|✅|❌|✅|✅|❌|  
|[Service endpoints (inbound)](../articles/azure-functions/functions-networking-options.md#service-endpoints-inbound)|✅|❌|✅|✅|✅|
|[Virtual network integration (outbound)](../articles/azure-functions/functions-networking-options.md#virtual-network-integration-outbound)|✅|❌|✅|✅<sup>3</sup>|✅| 

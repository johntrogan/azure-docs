...
* After you add an app to a profile, the **Default domain** on the app's **Overview** page displays the custom domain URL of the app, if you have set one up. Otherwise, it displays the Traffic Manager profile URL (for example, `contoso.trafficmanager.net`). Both the direct domain name of the app and the Traffic Manager URL are visible on the **Settings** > **Custom domains** page.

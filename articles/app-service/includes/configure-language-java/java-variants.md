...
- JBoss Enterprise Application Platform (EAP): The built-in JBoss EAP server can run an app deployed as a WAR or enterprise archive (EAR) package. This version is supported for Linux apps in a set of pricing tiers, which include Free, Premium v3, and Isolated v2.gti.

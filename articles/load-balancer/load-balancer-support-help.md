---
title: Azure Load Balancer support and help options
description: How to obtain help and support for questions or problems when you create solutions using Azure Load Balancer.
author: mbender-ms
ms.author: mbender
...
# Customer intent: As a cloud solutions developer, I want to access troubleshooting resources and support options for Azure Load Balancer, so that I can efficiently resolve issues and ensure reliable application delivery.
---

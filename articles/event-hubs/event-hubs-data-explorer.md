...
## Use Event Hubs Data Explorer

To use Event Hubs Data Explorer, navigate to the Event Hubs namespace on which you want to perform data operations.

You can either navigate to **Data Explorer** directly and then select the event hub, or select the event hub from **Entities** and then select **Data Explorer** from the navigation menu.
...
1. For **Content-Type**, select **Text/Plain**, **JSON**, or **XML**.
1. Either upload a JSON file or enter the payload in the **Enter payload** box.

...
> - Adding inputs and outputs in Azure Stream Analytics input and output blades. However, you can view the inputs and outputs generated by the no-code editor in input and output blade.
> - The following output types aren't available: Azure Function, ADLS Gen1, PostgreSQL DB, Service Bus queue/topic, Table storage.

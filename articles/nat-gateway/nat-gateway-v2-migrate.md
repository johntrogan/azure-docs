...
* A StandardV2 NAT gateway requires the use of StandardV2 public IPs. Existing Standard public IPs don't work with StandardV2 NAT gateways. Make sure you're able to re-IP to StandardV2 Public IPs before you create StandardV2 NAT Gateway.

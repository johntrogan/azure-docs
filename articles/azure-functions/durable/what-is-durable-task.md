...
- [Durable task for AI agents](./durable-task-for-ai-agents.md)
  - [Microsoft Agent Framework](./durable-agents-microsoft-agent-framework.md)
  - [Durable Functions and Durable Task SDKs](./durable-agents-deterministic-workflows.md)
- Get started with:

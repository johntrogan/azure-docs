...
NVMe storage interface | Supported | Supported for Azure-to-Azure for Windows for Gen2 VMs such as Da/Ea/Fa v6-series, Ebsv5/Ebdsv5 and others that use NVMe interface. <br/><br/> Ephemeral OD disks, local NVMe disks are not supported. |
Mixed controller VMs (SCSI + NVMe) | Not Supported | VMs SKUs such as Lsv3 are not supported |

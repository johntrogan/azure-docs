...
NVMe storage interface | Supported | Support in Preview for Windows for Gen2 VMs such as Da/Ea/Fa v6-series, Ebsv5/Ebdsv5 and others that use NVMe interface. <br/><br/> Ephemeral OD disks, local NVMe disks are not supported. |

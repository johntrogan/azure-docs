...
- Review [Get started with Microsoft Discovery Infrastructure](quickstart-infra-portal.md) before you begin this tutorial.
...
1. Under **Chat model**, select the model deployment created in the [previous tutorial](./quickstart-infra-portal.md#4-create-chat-model-deployment).

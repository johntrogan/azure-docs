...
→ [Upload Knowledge Documents(upload-knowledge-document.md) — full details on file types, limits, and agent-generated documents
...
→ [Share Files in Chat(file-attachments.md) — drag and drop, clipboard paste, and multimodal analysis

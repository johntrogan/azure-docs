...
1. Navigate to your **Application Insights** resource. If you don't have one yet, create it (**Create a resource** > **Application Insights**) and attach it to a Log Analytics workspace.

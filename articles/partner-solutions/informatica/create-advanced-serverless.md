...
Set the following values in the **Platform Detail** tab.
  ...
  | **Subnet**  | Select a subnet in the virtual network to use. |
...
You can specify custom tags for the new Informatica organization by adding custom key-value pairs. Set any required tags in the **Tags** tab.
  ...
  | Property | Description |
  |----------| -------------|
  | **Name** | Name of the tag that corresponds to the Azure Native Informatica resource. |
  | **Value** | Value of the tag that corresponds to the Azure Native Informatica resource. |

### Review and create

1. Select **Next: Review + Create** to navigate to the final step for serverless creation. The creation process validates the values for the deployment. Review all the selections made in **Basics**, and optionally **Tags**. Review the Informatica and Azure Marketplace terms and conditions.
...
> [Manage your Informatica organization](manage.md)

...
With [Durable Functions](../../azure-functions/durable-functions/durable-functions-overview.md), you can build deterministic agentic workflows with any AI framework. Write the workflow logic as ordinary code, including:
...
With the [Durable Task SDKs](../sdks/durable-task-overview.md), you can build deterministic agentic workflows with any AI framework. Write the workflow logic as ordinary code, including:
- The sequence of steps
- Branching
- Parallelism
- Error handling
...
The [Durable Task programming model](../common/programming-model-overview.md) maps naturally to deterministic agentic patterns: 
...
> [!NOTE]
> For a comparison of Durable Functions vs. the standalone Durable Task SDKs, see [Choose your orchestration framework](../common/choose-orchestration-framework.md).
...
The following examples use [Durable Functions](../../azure-functions/durable-functions/durable-functions-overview.md), one of the [Durable Task hosting options](../common/choose-orchestration-framework.md), which runs on Azure Functions with serverless hosting.
...
The following examples use the portable [Durable Task SDKs](../sdks/durable-task-overview.md), one of the [Durable Task hosting options](../common/choose-orchestration-framework.md). The SDKs run on any host compute, including Azure Container Apps, Kubernetes, virtual machines, or locally.
...
- [Learn if the Durable Task Scheduler is the best storage provider for your project](../scheduler/durable-task-scheduler.md)
- [Choose whether to use Durable Functions or the Durable Task SDKs](../common/choose-orchestration-framework.md)
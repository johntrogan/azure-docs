...
- [Durable Task for AI agents](../agents/durable-task-for-ai-agents.md)
  - [Building agentic workflows](../agents/durable-agents-deterministic-workflows.md)
  - [Microsoft Agent Framework extension](../agents/durable-agents-microsoft-agent-framework.md)
- Get started with:

...
To check for running instances, use the [instance management APIs](../../azure-functions/durable-functions/durable-functions-instance-management.md) to query orchestrations by status and verify none are still in progress with the old version.

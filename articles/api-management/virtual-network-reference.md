...
| Inbound & Outbound | VirtualNetwork | * | Virtual Network | 1000              | TCP                | Allow     | Access external Azure Managed Redis service for [caching](api-management-caching-policies.md) policies between machines (optional)        | External & Internal  |

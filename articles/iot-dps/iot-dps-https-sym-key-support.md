...
You call the [Register Device](/rest/api/iot-dps/data-plane/runtime-registration/register-device
) REST API to provision your device through DPS.
...
) REST API to determine when your device is assigned or whether a failure occurs.
